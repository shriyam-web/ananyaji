        ...
        <div className="w-full max-w-6xl h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center h-full">
            ...
            <div className="space-y-6 overflow-y-auto max-h-full pr-2">
              {/* Animated Container */}
              <div
                className={`rounded-3xl bg-white/80 backdrop-blur p-6 md:p-8 shadow-2xl transform transition-all duration-700 ${
                  showMore
              ...
              >
                {/* Title */}
                <h1
                  className={`text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-500 via-pink-500 to-amber-500 bg-clip-text text-transparent mb-3 transition-all duration-700 ${
                    showMore ? 'text-2xl md:text-3xl' : 'text-3xl md:text-4xl'
                  }`}
                >
                  {currentText.title}
                </h1>
